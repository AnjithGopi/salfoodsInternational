...
import { whatsappURL } from "../contact/whatsapp";
...
const WhatsAppButton = () => {
  ...
  return (
    <div className={`fixed ${currentPosition} z-[9999]`}>
      <a
        href={whatsappUrl}
        target="_blank"
        ...
        className={`
          ...
          hover:shadow-[0_12px_48px_rgba(37,211,102,0.5)]
        ...
        >
          ...
          <div
            className={`
              ...
              ${position.includes("right") ? "border-l-4 border-l-gray-900" : "border-r-4 border-r-gray-900"}
            `}
          />
        </div>
      </a>
