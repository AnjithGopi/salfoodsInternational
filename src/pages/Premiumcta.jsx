    ...
    <div className="mt-16 relative overflow-hidden">
      ...
      <div className="relative text-center rounded-2xl p-12 border border-white/20 backdrop-blur-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          {/* <button className="group relative bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center space-x-2">
