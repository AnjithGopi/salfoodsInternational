  ...
  const products = [
    {
      ...
      description: "Handcrafted with organic flour and traditional fermentation methods",
      price: "$8.99",
      originalPrice: "$12.99",
      rating: 4.9,
      reviews: 156,
    ...
    },
    {
      id: 2,
      name: "Palappam Batter",
      description: "Three premium sauces: Truffle Alfredo, Spicy Arrabbiata, and Basil Pesto",
      price: "$24.99",
      originalPrice: "$32.99",
      rating: 4.8,
      reviews: 89,
    ...
    },
    {
      id: 3,
      name: "Palappam Batter",
      description: "Grass-fed Wagyu beef patties with our signature seasoning blend",
      price: "$18.99",
      originalPrice: "$24.99",
      rating: 4.9,
      reviews: 203,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="mt-8 flex items-center justify-center space-x-2">
            ...
            <span className="text-gray-600 font-medium">Chef-Approved Quality</span>
          </div>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Nutrition Highlights</span>
                  </div>
        ...
        <div className="mt-16 text-center bg-[#A7C1A8] text-white rounded-2xl p-8">
          ...
          <p className="mb-6 max-w-2xl mx-auto opacity-90">
            Browse our full catalog of premium food products, seasonal specialties, 
            and chef-curated collections. New items added weekly!
          </p>
